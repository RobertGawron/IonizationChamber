 ...
 *
 * Verifies that clock_configurator_init performs all required initialization steps
 ...
 *
 * Verifies that clock_configurator_init properly waits for HSI to become ready
