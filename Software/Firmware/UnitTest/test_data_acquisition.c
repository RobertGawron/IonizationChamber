...
/**
 * @brief Mock implementation of data_frame_create
 *
 ...
 * 5. Execute data_acquisition_tick()
 *
    ...
    void **state)
{
    ...
    expect_value(data_frame_create, maxLength, MAX_FRAME_LENGTH);
    expect_value(data_frame_create, configuration, expected_config);
    expect_value(data_frame_create, measurement, expected_sample);
