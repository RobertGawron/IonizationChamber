...
#if defined(__AVR_AT90Tiny84A__) | defined(__AVR_ATtiny84A__)
#define DDR_USI             DDRB
#define PORT_USI            PORTB
#define PIN_USI             PINB
#define PORT_USI_SDA        PORTA5
#define PORT_USI_SCL        PORTA7
#define PIN_USI_SDA         PINA5
#define PIN_USI_SCL         PINA7
#endif
